import { Component, OnInit } from '@angular/core'   ////1.  Import our component decorator 
import { EventService } from './shared/event.service'
import { ToastrService } from '../common/toastr.service'
import { IEvent } from './shared/index'

@Component({  //2. decorate our class with it
    //selector: 'events-list',  //  selector of events list
    //template: '<div><h1>Upcoming Ang2 Events</h1></div>' // display the html for this
    // above is hard to read,  so changing to string literal with backticks        // es6   allows this multi line 
    //template: `   `
    template: `
       <div>
    ...
    <hr/>
    <div class="row">
      <div *ngFor="let event of eventsList" class="col-md-5">
...
// implements OnInit    is a typescript feature  we import , it
// then makes sure that we have a ngOnInit()   event  
export class EventsListComponent implements OnInit {
    ...
    //  private is shorthand for saying we have a property on our class like this
    // eventService

    // Inject also the ToastrService we created 
    constructor(
        private eventService: EventService, 
        private toastr: ToastrService){
        //this.eventService = eventService
        // private is shorhand for above line

        //refactor later
       // this.eventsList = this.eventService.getEvents()
        // don't put this into constructor 

        // ngOnInit lifecycle hook better to do 
    ...
    // now we open up our events-app component  
    //hard code this data for now 
    // event object 
    event13 = {
        id: 1,
        ...
        time: '10:00 am',
        price: 599.99,
        imageUrl: '/app/assets/images/angularconnnect-shield.png',
        location: {
            address: '1057 DT',
            city: 'London',
            country: 'England'
